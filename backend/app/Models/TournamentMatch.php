...
class TournamentMatch extends Model {
    ...
    protected function casts(): array{return ['score_a'=>'float','score_b'=>'float','best_of_sets'=>'integer','set_scores'=>'array','scheduled_at'=>'datetime','duration_minutes'=>'integer'];}
